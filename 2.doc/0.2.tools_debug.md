...
gdb打断点的时候可能会发一些系统信号，内核的wait就会被打断 wait_event_interruptible
可以使用 wait_event_timeout 等待，对于mpp也可以考虑使用修改之前的状态试一下，即
使用 wait_event_timeout 的状态
...
git clone ssh://git@repo.or.cz/openocd.git
